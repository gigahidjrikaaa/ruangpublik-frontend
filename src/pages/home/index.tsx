...
const MenuLink = (props: MenuLinkProps) => {
  ...
  return (
    <Link href={props.path}>
      <div
        className={`p-3 min-w-[217px] flex justify-start items-start rounded-[10px] font-semibold gap-3 transition duration-200 ${
          active
...
export default function Home() {
  ...
  return(
    <main className="bg-neutral-200 min-h-[200vh] flex pt-[60px]">
      <Navbar />
      <aside className="flex-shrink-0 pt-12 px-5 bg-white min-h-screen flex flex-col items-start gap-2">
      ...
      <section className="px-9 pt-[40px] w-full">
        <Thread />
      </section>

      <aside className="bg-white h-fit mt-[40px] text-black flex-shrink-0 font-semibold p-6 mr-4 rounded-[12px] shadow-md sticky top-[100px]">
        <h1 className="text-[18px] mb-5">Topik-Topik</h1>
        <div className="flex flex-col gap-6">
          <button className="min-w-[175px] text-left flex gap-[10px]">
